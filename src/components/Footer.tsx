        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Your smart travel companion for discovering and experiencing the world.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/booking" className="text-gray-400 hover:text-white">Book Tickets</Link></li>
